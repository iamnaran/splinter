 ...
 * @property dispatchIntervalDurationInMinute The interval in hours at which events are dispatched.
...
data class Config(
    ...
    var dispatchIntervalDurationInMinute: Long = Constants.DISPATCH_INTERVAL_DURATION_IN_MINUTE,
    ...
    fun isValid(): Boolean {
        return dispatchIntervalDurationInMinute > 5 && maxCachedEvents > 10 && sessionTimeOutDurationInMinute > 0 && isValidTimeOutDuration()
    }
